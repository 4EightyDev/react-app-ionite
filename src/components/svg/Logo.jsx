		...
		<a
			...
			<svg
				...
				className={classNames(
					scrollPosition > 0
						? 'relative z-50 h-[60px] opacity-0 transition-all duration-500'
						: 'relative z-50 h-[60px] transition-all delay-200 duration-500'
				)}
			...
			<svg
				...
				className={classNames(
					scrollPosition > 0
						? 'opacity-1 absolute left-0 top-[.01rem] z-30 h-[60px] transition-all delay-200 duration-500'
