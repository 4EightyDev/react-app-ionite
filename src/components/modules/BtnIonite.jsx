const BtnPrimary = (props) => {
	return (
		<button
			className={`duration-400 rounded-full shadow-lg shadow-sky-500/10 transition-all hover:scale-105 hover:shadow-xl hover:shadow-sky-500/10 ${props.className}`}>
