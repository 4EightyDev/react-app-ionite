...
const Ionite = () => {
     return (
          <a href='/' className='relative scale-75' title='ionite&#8482; - Identity Amplified&#8482;'>
               <svg id='ionite-logo' className='h-[60px] opacity-0 ml-[-2rem] sm:ml-0 sm:opacity-100 transition-all duration-500' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 89.56">
                    <linearGradient id="three-color-gradient" x1="189.7" y1="117.43" x2="38.17" y2="-34.1" gradientTransform="matrix(1, 0, 0, 1, 0, 0)" gradientUnits="userSpaceOnUse">
                         <stop offset={0} stopColor="var(--green-400)" />
                         <stop offset={.5} stopColor="var(--sky-500" />
               ...
               <svg id='ionite-mark' className='h-[60px] absolute top-0 left-0 sm:left-[1rem] sm:opacity-0 transition-all duration-500' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32.12 51.35">
                    <linearGradient id="two-color-gradient" x1="27.42" y1="37.03" x2="4.7" y2="14.32" gradientTransform="matrix(1, 0, 0, 1, 0, 0)" gradientUnits="userSpaceOnUse">
                         <stop offset={0} stopColor="var(--green-400)" />
